...
////////////////////////////////////////////////////////////////////////////////////////////////////
void Display::AdjustWindowSize(uint32_t&, uint32_t&) const
{
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void Display::PlayAudio(const Uri& uri, float volume)
{
    Audio::Play(uri, volume);
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Delegate<Display::ScaleChangedT>& Display::ScaleChanged()
{
    return mScaleChanged;
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Delegate<Display::SaveStateT>& Display::SaveState()
{
    return mSaveState;
}
...
{
    ArrayRef<Symbol> v = Factory::EnumComponents(Symbol("Display"));
    NS_CHECK(!v.Empty(), "Display implementation not found");
    return StaticPtrCast<Display>(Factory::CreateComponent(v[0]));
}
