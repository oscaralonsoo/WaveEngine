...
if exist Shaders_x.h del Shaders_x.h
...
bin2h.py Shaders.z Shaders >> Shaders_x.h
...
:fxc_vs
    ...
    "%GXDKLatest%bin\XboxOne\dxc" -T vs_6_0 -nologo -O3 -Zi -Fd pdb\ -Qstrip_reflect -Qstrip_rootsignature -D__XBOX_DISABLE_PRECOMPILE_LS=1 -D__XBOX_DISABLE_PRECOMPILE_ES=1 -D__XBOX_DX12_ROOT_SIGNATURE=%1 -Fo %2.o %3 %4 %5 %6 %7 %8 %9 > NUL
    if %errorlevel% neq 0 EXIT /B %errorlevel%
    tar.py Shaders.tar %2.o >> Shaders_x.h
    del %2.o
    EXIT /B 0

:fxc_ps
    "%GXDKLatest%bin\XboxOne\dxc" -T ps_6_0 -nologo -O3 -Zi -Fd pdb\ -Qstrip_reflect -Qstrip_rootsignature -D__XBOX_STRIP_DXIL -D__XBOX_DX12_ROOT_SIGNATURE=%1 -Fo %2.o %3 %4 %5 %6 %7 %8 %9 > NUL
    if %errorlevel% neq 0 EXIT /B %errorlevel%
    tar.py Shaders.tar %2.o >> Shaders_x.h
    del %2.o
    EXIT /B 0