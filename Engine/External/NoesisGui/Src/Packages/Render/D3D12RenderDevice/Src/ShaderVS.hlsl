...
void main(in In i, out Out o)
{
    ...
    o.color.r = (half)SRGBToLinear(i.color.r);
    o.color.g = (half)SRGBToLinear(i.color.g);
    o.color.b = (half)SRGBToLinear(i.color.b);
    o.color.a = (half)i.color.a;
  #else
    o.color = (half4)i.color;
  #endif
#endif
