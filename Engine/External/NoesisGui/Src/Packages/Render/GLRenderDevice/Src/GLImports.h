...
////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    GL_IMPORT(false, PFNGLBLENDFUNCSEPARATEPROC, glBlendFuncSeparate);
#endif
        ...
        GL_IMPORT(true, PFNGLGETUNIFORMBLOCKINDEXPROC, glGetUniformBlockIndex);
        GL_IMPORT(true, PFNGLUNIFORMBLOCKBINDINGPROC, glUniformBlockBinding);
        GL_IMPORT(true, PFNGLBINDBUFFERRANGEPROC, glBindBufferRange);
    #endif
        ...
        GL_IMPORT(true, PFNGLBUFFERSTORAGEPROC, glBufferStorage);
    #endif

    #if GL_VERSION_3_2 || GL_ES_VERSION_3_0
        GL_IMPORT(true, PFNGLFENCESYNCPROC, glFenceSync);
        GL_IMPORT(true, PFNGLCLIENTWAITSYNCPROC, glClientWaitSync);
        GL_IMPORT(true, PFNGLDELETESYNCPROC, glDeleteSync);
    #endif
        ...
        GL_IMPORT(true, PFNGLBUFFERSTORAGEEXTPROC, glBufferStorageEXT);
    #endif
        ...
        GL_IMPORT(true, PFNGLBINDVERTEXARRAYPROC, glBindVertexArrayAPPLE);
        GL_IMPORT(true, PFNGLDELETEVERTEXARRAYSPROC, glDeleteVertexArraysAPPLE);
        GL_IMPORT(true, PFNGLGENVERTEXARRAYSPROC, glGenVertexArraysAPPLE);
        GL_IMPORT(true, PFNGLISVERTEXARRAYPROC, glIsVertexArrayAPPLE);
    #endif
        ...
        GL_IMPORT(true, PFNGLBLITFRAMEBUFFERPROC, glBlitFramebufferEXT);
    #endif
        ...
        GL_IMPORT(true, PFNGLRENDERBUFFERSTORAGEMULTISAMPLEPROC, glRenderbufferStorageMultisampleEXT);
    #endif
        ...
        GL_IMPORT(true, PFNGLSTARTTILINGQCOMPROC, glStartTilingQCOM);
        GL_IMPORT(true, PFNGLENDTILINGQCOMPROC, glEndTilingQCOM);
    #endif

    #if GL_VERSION_3_1 || GL_ES_VERSION_3_0
        GL_IMPORT(true, PFNGLDRAWELEMENTSINSTANCEDPROC, glDrawElementsInstanced);
    #endif
#endif
