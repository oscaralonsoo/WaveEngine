static const char* Shader_300es_stereo_vert = R"(
...
void main()
{
    int base =  int(gl_ViewID_OVR) * 16;

    gl_Position = vec4(attr_pos, 0, 1) * mat4
    (
        cbuffer0_vs[base + 0], cbuffer0_vs[base + 1], cbuffer0_vs[base + 2], cbuffer0_vs[base + 3],
        cbuffer0_vs[base + 4], cbuffer0_vs[base + 5], cbuffer0_vs[base + 6], cbuffer0_vs[base + 7],
        cbuffer0_vs[base + 8], cbuffer0_vs[base + 9], cbuffer0_vs[base + 10], cbuffer0_vs[base + 11],
        cbuffer0_vs[base + 12], cbuffer0_vs[base + 13], cbuffer0_vs[base + 14], cbuffer0_vs[base + 15]
    );
