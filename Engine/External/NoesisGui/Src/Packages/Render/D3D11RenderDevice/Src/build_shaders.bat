...
CALL :fxc_vs Quad QuadVS.hlsl
CALL :fxc_ps Resolve2 ResolvePS.hlsl "/DNUM_SAMPLES=2"
CALL :fxc_ps Resolve4 ResolvePS.hlsl "/DNUM_SAMPLES=4"
CALL :fxc_ps Resolve8 ResolvePS.hlsl "/DNUM_SAMPLES=8"
CALL :fxc_ps Resolve16 ResolvePS.hlsl "/DNUM_SAMPLES=16"
