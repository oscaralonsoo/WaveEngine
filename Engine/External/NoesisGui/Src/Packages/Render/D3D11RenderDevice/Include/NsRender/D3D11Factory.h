...
struct NS_RENDER_D3D11RENDERDEVICE_API D3D11Factory
{
    ...
    static void EnableScissorRect(Noesis::RenderDevice* device);
    static void DisableScissorRect(Noesis::RenderDevice* device);
    static void* CreatePixelShader(Noesis::RenderDevice* device, const char* label,
