...
#ifndef __RENDER_D3D12MEDIAPLAYER_H__
#define __RENDER_D3D12MEDIAPLAYER_H__
...
////////////////////////////////////////////////////////////////////////////////////////////////////
class D3D12MediaPlayer: public MediaPlayer
{
public:
...
private:
    D3D12MediaPlayer(MediaElement* owner, const Noesis::Uri& uri, void* user);
    ~D3D12MediaPlayer();
    ...
    Noesis::Texture* TextureRender();

    int64_t GetCurrentTimestamp() const;

    void TransitionVideoTexture(ID3D12GraphicsCommandList* graphicsCommandList);
    ...
    ID3D12CommandAllocator* mD3D12VideoCommandAllocator[2] = { nullptr, nullptr };
    ID3D12VideoProcessCommandList* mD3D12VideoCommandList = nullptr;
    ID3D12Resource* mD3D12VideoTexture[2] = { nullptr, nullptr };
    ID3D11Texture2D* mD3D11VideoTexture[2] = { nullptr, nullptr };
    ID3D12Resource* mD3D12RGBATexture = nullptr;
    uint32_t mFrameIndex = 0;
    uint64_t mCommandAllocatorFenceValue[2] = { 0, 0 };
    uint64_t mVideoTextureFenceValue;
    ...
    Noesis::Ptr<Noesis::Texture> mTexture;
