...
// Microsoft VC++
    ...
    // This could be better implemented as '__noop' or '(void)sizeof(__VA_ARGS__)' but it is not
    // supressing unused variable warnings in VS2015. Besides we are using lambdas in our asserts
    // and that's not compatible with sizeof (unevaluated context error)
